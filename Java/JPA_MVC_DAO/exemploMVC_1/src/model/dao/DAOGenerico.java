...
import model.entity.EntidadeBase;
...
public class DAOGenerico<T extends EntidadeBase> {
    ...
    private EntityManager getEntityManager() {
        ...
        factory = Persistence.createEntityManagerFactory("exemploJPAPU");
    ...
    public List<T> obtemPorNome(Class<T> classe, String name){
        
        return entityManager.createNamedQuery(classe.getSimpleName()+".findByNome").setParameter("nome", "%" + name + "%").getResultList();
